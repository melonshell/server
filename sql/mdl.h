...
enum enum_mdl_type {
  ...
  */
  ...
  /*
    ...
    case.
    This lock is taken for global read lock and when caching a stored
    procedure in memory for the duration of the transaction.
  */
  MDL_SHARED,
  /*
  ...
  */
  MDL_SHARED_READ,
  /*
    A shared metadata lock (SR) for cases when there is an intention to modify
  ...
  */
  MDL_SHARED_WRITE,
  /*
    An upgradable shared metadata lock (SW) for cases when there is an
